...
High-DR profile sites for SEO backlinks. Profiles should be personal (Rubén as engineer) with Partle featured as a project. Bios drafted in partle repo at `.agents/drafts/profile-bios.md`. Screenshots for dribbble/behance at `.agents/drafts/screenshot-*.png`.
