...
- ✅ Removes [contracting leverage](../facts/1.1.4-contracting-leverage.md)
...
See: [Immigration Barriers](../facts/1.5-immigration-barriers.md)
...
- ✅ Removes [labor cost barriers](../facts/1.4-labor-costs.md)
...
- Solves [geographic captivity](../facts/1.1.1-geographic-captivity.md)
...
The [Nash equilibrium](../facts/1.8-nash-equilibrium.md) trapping the US healthcare system is **strong but not unbreakable**.

**What's required:**
1. Address pricing power (single-payer OR all-payer OR hybrid)
2. Fix insurer incentives (eliminate MLR OR change payment model)
3. Reduce labor costs (immigration + education reform)
4. Lower entry barriers (regulatory reform)
5. Maintain quality and access (careful implementation)
